...
const ConfortUpdater = React.lazy(() => import('./ConfortUpdater'));

const SpatiiUpdater = React.lazy(() => import('./SpatiiUpdater'));
const CentralizatorSpatii = React.lazy(() => import('./CentralizatorSpatii'));

const PaturiUpdater = React.lazy(() => import('./PaturiUpdater'));
const HotelUpdater = React.lazy(() => import('./HotelUpdater'));
...
class HotelOverview extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      components: {
        ...
        CentralizatorSpatii: CentralizatorSpatii,
      ...
      spatiiIconClass: 'fas fa-door-open --overview-icon',
  ...
  changeView(component=this.state.defaultComponentName) {
    ...
    this.setState({
      ...
      spatiiIconClass: nextSpatiiIconClass,
    })
  }
