...
INSERT INTO "UtilizatoriRoluri" ("ID","UtilizatorID","RolID") VALUES (0,0,0),
 (1,1,1);
INSERT INTO "Utilizatori" ("ID","CNP","Grad","Nume","Prenume","Utilizator","Parola","Extra") VALUES (0,'#','#','#','#','admin','IFckTyjzH/qwhFiAHJ6M0DvmSgkeCA5FqCMRysTwYyw=','*Ddq!c}?==?J'),
 (1,'1920923152504','Lt.','Moldoveanu','Dan','daniel','EgoHcN/aqTxgJeCPsQqGHP23QNzfzo/5CpD6DLeDrco=','6moHwORnXg8glVbk');
COMMIT;
